...
Класична лінійна регресія (МНК) визначила коефіцієнт нахилу (beta) на рівні 2,3376 та точку перетину (alpha) 12,0746, що формує єдину лінію прогнозу. Байєсівська модель, реалізована методом MCMC, підтвердила ці розрахунки, отримавши аналогічні середні значення (mean): 2,347 для beta та 11,846 для alpha. Проте байєсівський метод надає не просто точкові оцінки, а ймовірнісні інтервали найвищої щільності (HDI). Зокрема, з імовірністю 94% вплив температури на енергоспоживання знаходиться в межах від 2,095 до 2,585 кВт⋅год на градус.
